    ...
    return (
        ...
        {/* Top Nav Bar */}
            ...
            <div className = "w-1/3 flex justify-center items-center">
                ...
                <li className='hover:text-emerald-500 hover:scale-110 active:scale-95 cursor-pointer'>Create</li>
                <li className='hover:text-emerald-500 hover:scale-110 active:scale-95 cursor-pointer'>My Words</li>
                </ul>
